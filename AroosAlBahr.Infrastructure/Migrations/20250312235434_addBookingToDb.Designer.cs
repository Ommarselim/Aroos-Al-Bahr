...
namespace AroosAlBahr.Infrastructure.Migrations
{
    ...
    [Migration("20250312235434_addBookingToDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AroosAlBahr.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AroosAlBahr.Domain.Entities.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AroosAlBahr.Domain.Entities.Booking", b =>
                {
                    b.HasOne("AroosAlBahr.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AroosAlBahr.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
